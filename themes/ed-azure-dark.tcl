# This is a modified version of https://github.com/rdbende/Azure-ttk-theme to match the Elite Dangerous theme
...
namespace eval ttk::theme::ed-azure-dark {

    variable version 1.3
    package provide ttk::theme::ed-azure-dark $version
    variable colors
    array set colors {
        -fg             "#FF8000"
        -bg             "#000000"
    ...
    LoadImages [file join [file dirname [info script]] ed-azure-dark]

    # Settings
    ttk::style theme create ed-azure-dark -parent default -settings {
        ttk::style configure . \
